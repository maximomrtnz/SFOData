...
def get_metadata():	
	...
	xml += '<EntitySet Name="Producto" EntityType="DataHubModel.Producto"/>'
	xml += '<EntitySet Name="Productor" EntityType="DataHubModel.Productor"/>'
	xml += '<AssociationSet Name="FK_Producto_Productor" Association="DataHubModel.FK_Producto_Productor">'
